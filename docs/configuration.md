...
| `[layout.footer]` **Footer Options** | | | | |
| `layout.footer.items` | Array[String] | `["Generated by Lssg"]` | Footer HTML elements or text | Yes |
| `layout.footer.custom` | String | - | Custom footer HTML (replaces `items`) | Yes |
...
<!-- Automatically has language="de", nav.kind="sidemenu", layout.footer.watermark=true -->
# Tutorial 1
```
...
-->
# Tutorial 2
<!-- Still inherits nav.kind="sidemenu" and layout.footer.watermark=true -->
```
